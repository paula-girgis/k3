...
import leaf from '../../assets/gradMaterial/leaf.webp'; 
...
//       <motion.h2 
//         className="homeFont text-center mt-16 mb-10 text-6xl font-extrabold text-green-900"
...
//         <div className="relative border-dashed border-4 border-green-700 rounded-xl shadow-2xl p-6 w-3/4 flex items-center justify-center min-h-[300px]">
//           {isCameraOpen ? (
//             <>
...
//               ></video>
//               <button onClick={capturePhoto} className="absolute bottom-4 bg-green-800 text-green-100 px-6 py-2 rounded-full text-sm shadow-md hover:bg-green-600 hover:scale-105 transition duration-300">
//                 Capture Photo
//               </button>
...
//             />) : (
//             <p className="text-black">No image or camera feed yet. Start by selecting an option below.</p>)}
...
//           <button
//             onClick={startCamera}
//             className="bg-green-800 text-green-100 mt-10 px-14 py-3 rounded-full text-lg shadow-md hover:bg-green-600 hover:scale-105 transition duration-300"
//           >
//             Open Camera
//           </button>
//           <input
...
//           <label
//             htmlFor="file-upload"
//             className="bg-green-800 text-green-100 px-8 py-3 rounded-full text-lg shadow-md hover:bg-green-600 hover:scale-105 transition duration-300 flex items-center justify-center cursor-pointer"
//           >
//             Upload Photo
//           </label>
//         </div>
...
//             className="mt-6 bg-green-800 text-green-100 px-8 py-3 rounded-full text-lg shadow-md hover:bg-green-600 hover:scale-105 transition duration-300"
//           >
...
//         {response && (
//           <motion.div
//             className="mt-12 bg-gray-200 p-8 text-center rounded-xl shadow-lg max-w-4xl w-full"
